var routes = [
  ...
  {
    path: '/geografia/',
    componentUrl: './pages/geografia.html',
  },
  {
    path: '/costumbres/',
    componentUrl: './pages/costumbres.HTML',
  },
  {
    path: '/gastronomia/',
    componentUrl: './pages/gastronomia.html',
  },
  {
    path: '/historia/',
    componentUrl: './pages/historia.html',
  },
  {
    path: '/cultura/',
    componentUrl: './pages/cultura.html',
  },
  {
    path: '/autores/',
