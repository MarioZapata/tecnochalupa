var routes = [
    ...
    {
        path: '/ruleta/',
        componentUrl: './pages/ruleta.html',
    },
    {
        path: '/jugador/',
        componentUrl: './pages/jugador.html',
    },

    {
        path: '/1/',
        componentUrl: './pages/1.html',
    },
    {
        path: '/2/',
        componentUrl: './pages/2.html',
    },
    {
        path: '/4/',
        componentUrl: './pages/4.html',
    },
    {
        path: '/3/',
        componentUrl: './pages/3.html',
    },
    {
        path: '/5/',
        componentUrl: './pages/5.html',
    },
    {
        path: '/6/',
        componentUrl: './pages/6.html',
    },
    {
        path: '/7/',
        componentUrl: './pages/7.html',
    },
    {
        path: '/8/',
        componentUrl: './pages/8.html',
    },
    {
        path: '/9/',
        componentUrl: './pages/9.html',
    },
    {
        path: '/10/',
        componentUrl: './pages/10.html',
    },
    {
        path: '/11/',
        componentUrl: './pages/11.html',
    },
    {
        path: '/12/',
        componentUrl: './pages/12.html',
    },
    {
        path: '/13/',
        componentUrl: './pages/13.html',
    },
    {
        path: '/14/',
        componentUrl: './pages/14.html',
    },
    {
        path: '/15/',
        componentUrl: './pages/15.html',
    },
    {
        path: '/16/',
        componentUrl: './pages/16.html',
    },
    {
        path: '/17/',
        componentUrl: './pages/17.html',
    },
    {
        path: '/18/',
        componentUrl: './pages/18.html',
    },
    {
        path: '/19/',
        componentUrl: './pages/19.html',
    },
    {
        path: '/20/',
        componentUrl: './pages/20.html',
    },
    {
        path: '/21/',
        componentUrl: './pages/21.html',
    },
    {
        path: '/rol/',
        componentUrl: './pages/rol.html',
    },
    {
        path: '/salir/',
        componentUrl: './pages/salir.html',
    },
    {
        path: '/autores/',
        componentUrl: './pages/Autores.html',
    },
    {
        path: '/acerca/',
        componentUrl: './pages/acerca.html',
    },
    {
        path: '/reglas/',
        componentUrl: './pages/reglas.html',
    },

    {
        path: '/Galeria/',
        componentUrl: './pages/Galeria.html',
    },
    {
